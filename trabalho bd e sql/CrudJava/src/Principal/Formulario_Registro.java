...
public class Formulario_Registro extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lbltitle.setBackground(new java.awt.Color(60, 63, 65));
        lbltitle.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lbltitle.setForeground(new java.awt.Color(0, 204, 204));
        lbltitle.setName(" REGISTRAR NOVO USUÁRIO"); // NOI18N
        lbltitle.setText(" REGISTRAR NOVO USUÁRIO");
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        if(this.txtnome.getText().length() == 0 || this.txtusuario.getText().length() == 0
            ...
            if(Funciones.isRegister(s)){
                ...
                JOptionPane.showMessageDialog(this, "ERRO AO FAZER NOVO REGISTRO.", "ERRO", JOptionPane.ERROR_MESSAGE);
            }
        }
